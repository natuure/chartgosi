...
async def get_answer_result(session: AsyncSession, answer_id: str, user_id: str) -> AnswerResultResponse | None:
    ...
    return AnswerResultResponse(
        ...
        pattern_score_breakdown=answer["pattern_score_breakdown"],
        pattern_markers=answer["pattern_markers"] or [],
        is_synthetic=answer["is_synthetic"],
        source_name=answer["source_name"],
        source_url=answer["source_url"],
        source_symbol=answer["source_symbol"],
        source_exchange=answer["source_exchange"],
        source_date_range=answer["source_date_range"],
