INSERT INTO patterns (id, slug, name, description, definition, sort_order) VALUES
  ...
  (
    ...
    'bullish-engulfing',
    '상승장악형',
    '52주 신고가 대비 충분히 하락한 위치에서 음봉 뒤 양봉이 몸통을 완전히 감싸며 반전 가능성을 보여주는 일봉 캔들 패턴입니다.',
    '{
      "summary": "일봉 기준 첫째 날 음봉과 둘째 날 양봉으로 완성되는 반전형 캔들 패턴입니다.",
      "timeframe": "1d",
      "chart_ma": ["MA50", "MA150", "MA200"],
      "structure": ["첫째 날 음봉, 둘째 날 양봉", "둘째 날 양봉 몸통이 첫째 날 음봉 몸통을 완전히 장악", "음봉 시작일 이전 252거래일 최고 종가 대비 20% 이상 하락한 위치"],
      "confirmation": ["음봉과 양봉 모두 꼬리가 짧음", "양봉 몸통이 음봉 몸통보다 큼", "패턴 완성 후 10거래일 동안 기준 종가를 이탈하지 않음"],
      "invalidation": ["캔들 순서 불일치", "몸통 장악 실패", "52주 신고가 대비 하락률 20% 미만", "음봉 또는 양봉 꼬리 합 30% 초과", "10거래일 확정 중 기준 종가 이탈"],
