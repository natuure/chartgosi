INSERT INTO patterns (id, slug, name, description, definition, sort_order) VALUES
  (
    ...
    '{
      ...
      "structure": ["주봉 기준 5봉 이내 30% 이상 급등", "최소 4주 이상 완만한 U자형 컵 형성", "오른쪽 림 이후 1~5주 이내의 컵보다 얕은 핸들 형성"],
      ...
      "scorecard": {
        ...
        "criteria": [
          ...
          {"key": "handle_quality", "label": "오른쪽 림 이후 1~5주 핸들", "max_points": 15, "description": "핸들은 오른쪽 림 이후 형성되고, 종가가 오른쪽 림 종가의 101% 이상이 되는 봉의 바로 전 봉까지로 정의합니다. 형성 기간은 1~5주가 이상적이며, 5주를 넘으면 감점합니다. 최대 낙폭은 20% 이내이고 컵 구간 하락폭보다 작아야 합니다. 핸들 저가가 컵 바닥 저가보다 낮으면 후보에서 제외하고, 컵 바닥 종가에 5% 이내로 근접하면 감점합니다."}
        ],
        "deductions": [
